...
![share-jgt](../SpringAiProjectImages/share-jgt.png)
...
![fe8a5f53_1915710](../SpringAiProjectImages/fe8a5f53_1915710.png)
...
<img src="../SpringAiProjectImages/docker001.png" style="zoom:67%;" />
...
<img src="../SpringAiProjectImages/1708329697454.png" alt="70832969745" style="zoom:67%;" />

当前RuoYi-Cloud 微服务版本：3.6.3

查看项目版本如图：

![70832987768](../SpringAiProjectImages/1708329877689.png)

项目版本jdk为：1.8，spring-boot为：2.7.18，不是我们预期的版本，因此我们给改项目做了升级，升级后的项目模板在：资料/项目模板/share-parent.zip

升级后的项目版本如图：

![70833011254](../SpringAiProjectImages/1708330112547.png)
...
<img src="../SpringAiProjectImages/1709178406142.png" alt="1709178406142" style="zoom:67%;" />

##### 3、导入项目源码到idea，如图：

![73206654654](../SpringAiProjectImages/1732066546543.png)
...
<img src="../SpringAiProjectImages/1709186383216.png" alt="1709186383216" style="zoom:80%;" />

导入成功后，如图：

![73206686106](../SpringAiProjectImages/1732066861067.png)

> ⭐️⭐️**默认使用的是public配置，如果想用其他的配置，比如说用share配置的话，要把后面这串标识符在代码里的配置文件中进行配置，配置一下namespace**
>
> ![73206686106](../SpringAiProjectImages/1.png)
